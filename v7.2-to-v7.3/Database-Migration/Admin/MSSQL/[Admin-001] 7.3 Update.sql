...
PRINT N'Updating Admin Database to 7.3';
GO

PRINT N'Creating Procedure [dbo].[CreateClientAccessToken]...';
GO
...
INSERT [dbo].[DeployJournal] ([Id], [ScriptName], [Applied]) VALUES (34, N'Artifacts.MsSql.Structure.Admin.0175-Add-CreateClientAccessToken.sql', GETDATE())
GO

INSERT [dbo].[DeployJournal] ([Id], [ScriptName], [Applied]) VALUES (35, N'Artifacts.MsSql.Structure.Admin.0176-Update-CreateClientAccessToken.sql', GETDATE())
GO
