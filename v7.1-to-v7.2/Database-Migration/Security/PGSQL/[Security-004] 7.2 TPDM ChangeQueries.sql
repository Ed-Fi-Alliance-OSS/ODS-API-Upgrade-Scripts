...
-- Applying 0020-EdFi-ApiPublisher-Reader-ReadChanges.sql
DO $$
DECLARE
...
-- Updating TPDM ChangeQueries DeployJournal Scripts
BEGIN;

    INSERT INTO public."DeployJournal" (scriptname, applied) VALUES ('Extensions.TPDM.1.1.0.Standard.5.1.0.Artifacts.PgSql.Data.Security.Changes.0010-EdFi-Sandbox-ReadChanges.sql', now()::timestamp);
    INSERT INTO public."DeployJournal" (scriptname, applied) VALUES ('Extensions.TPDM.1.1.0.Standard.5.1.0.Artifacts.PgSql.Data.Security.Changes.0020-EdFi-ApiPublisher-Reader-ReadChanges.sql', now()::timestamp);
